...
gantt
    ...
    section 密度 ρ
    随机游走 1.05-1.35 t/m³ :rho, 0, 3600
    
    section 物料组分
    P1 基线 (WOA-BP标称) :crit, p1, 0, 600
    P2 阶跃 (难筛+9%, 阻塞+3.5%) :active, p2, 600, 1200
    P3 有色噪声波动 :p3, 1200, 2200
    P4 指数回归基线 (τ=200s) :p4, 2200, 2600
    P5 大颗粒突增+8% :crit, p5, 2600, 3000
    P6 平滑恢复 (τ=300s) :p6, 3000, 3600
```
